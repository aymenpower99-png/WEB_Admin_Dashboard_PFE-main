...
export default function Shell({
  ...
  const navigate = (
    page: string,
    prefill?: Vehicle | VehicleClass | string | null,
  ) => {
    const targetPath =
        ...
        >
          ...
          >
            <Routes>
              ...
              <Route
                path="dashboard"
                element={<AdminDashboard dark={dark} />}
              />
              ...
              <Route
                path="classes"
                element={<ClassesPage onNavigate={navigate} />}
              />
              <Route
                path="classes-add"
                element={
                  <AddClassPage prefill={editClass} onNavigate={navigate} />
                }
              />
              <Route
                path="class-detail"
              ...
              {/* ── Billing ── */}
              <Route
                path="agency-billing-overview"
                element={<AgencyBillingOverviewPage />}
              />
              <Route
                path="agency-billing-payments"
                element={<AgencyBillingTripPaymentsPage />}
              />
              <Route
                path="agency-billing-earnings"
                element={<AgencyBillingDriverEarningsPage />}
              />
              ...
              <Route
                ...
                element={<CommissionTiersPage />}
              />
              <Route path="help" element={<HelpCenter dark={dark} />} />
              <Route
                path="help-center"
                element={<HelpCenterAdmin dark={dark} onNavigate={navigate} />}
              />
              <Route
                path="help-center-add"
                element={
                  <AddArticlePage prefill={null} onNavigate={navigate} />
                }
              />
              <Route
                path="help-center-edit"
                element={
                  <AddArticlePage prefill={editArticle} onNavigate={navigate} />
                }
              />
              <Route
                path="settings"
