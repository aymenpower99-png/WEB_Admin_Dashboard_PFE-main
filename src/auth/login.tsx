...
export default function LoginAdmin({ onLogin }: { onLogin: (dark: boolean) => void }) {
  ...
  return (
    ...
    >
      ...
      {/* ── Left panel ── */}
      <div
        className="flex-1 flex flex-col justify-between transition-colors duration-300"
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div
                ...
                style={{ color: t.heading, letterSpacing: "-0.5px" }}
              >
                Moviroo
              </div>
        ...
        <div>
          ...
          <h1
            className="font-black leading-none mb-5 transition-colors duration-300"
          ...
          <p
            className="text-sm leading-relaxed max-w-sm transition-colors duration-300"
            style={{ color: t.sub }}
          >
          ...
          {/* KPI row */}
          <div
            className="flex mt-12 rounded-2xl overflow-hidden transition-colors duration-300"
          ...
          >
            {[
              ...
              <div
                key={s.label}
                className="flex-1 p-5 transition-colors duration-300"
                style={{
              ...
              >
                ...
                <div
                  ...
                  style={{ color: t.kpiVal, letterSpacing: "-0.5px" }}
                >
                  {s.value}
                </div>
                <div
                  className="text-xs mt-1 tracking-wide transition-colors duration-300"
                  style={{ color: t.kpiLbl }}
                >
                  {s.label}
                </div>
              </div>
      ...
      {/* ── Right login panel ── */}
      <div
        className="w-[480px] flex items-center justify-center transition-colors duration-300"
      ...
      >
        <div className="w-full">
          ...
          <div className="mb-10">
            <h2
              className="font-extrabold mb-2 transition-colors duration-300"
              style={{ fontSize: 28, color: t.heading, letterSpacing: "-1px" }}
            >
              Sign in
            </h2>
          ...
          {/* Security note */}
          <div
            className="flex items-start gap-2 mt-7 rounded-xl p-4 transition-colors duration-300"
            style={{ background: t.securityBg, border: `1px solid ${t.securityBd}` }}
          >
            <span className="text-base flex-shrink-0 mt-0.5">🛡</span>
            <p
              className="text-xs leading-relaxed m-0 transition-colors duration-300"
              style={{ color: t.securityTxt }}
            >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.color = t.googleHoverTxt;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = t.googleBg;
              e.currentTarget.style.color = t.googleTxt;
            }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24">
              <path
                d="M21.6 12.227c0-.868-.075-1.703-.216-2.506H12v4.737h5.381a4.6 4.6 0 01-1.995 3.018v2.508h3.23c1.892-1.742 2.984-4.306 2.984-7.757z"
                fill="#4285F4"
              />
              <path
                d="M12 22c2.7 0 4.965-.895 6.616-2.416l-3.23-2.508c-.896.6-2.042.954-3.386.954-2.604 0-4.81-1.76-5.6-4.122H3.07v2.59A9.996 9.996 0 0012 22z"
                fill="#34A853"
              />
              <path
                d="M6.4 13.908A6.008 6.008 0 016.085 12c0-.664.114-1.31.315-1.908V7.502H3.07A9.996 9.996 0 002 12c0 1.614.387 3.14 1.07 4.498l3.33-2.59z"
                fill="#FBBC05"
              />
              <path
                d="M12 5.97c1.467 0 2.783.505 3.817 1.496l2.862-2.862C16.96 2.99 14.696 2 12 2 8.337 2 5.19 4.07 3.07 7.502l3.33 2.59C7.19 7.729 9.396 5.97 12 5.97z"
                fill="#EA4335"
              />
            </svg>
